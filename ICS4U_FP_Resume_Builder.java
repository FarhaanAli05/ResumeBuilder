...
public class ICS4U_FP_Resume_Builder {
    ...
    public static void main(String[] args) throws IOException {
        ...
        scanner.nextLine();
        String fileLine;
    	BufferedReader reader = new BufferedReader(new FileReader("D:\\Eclipse\\Project1\\src\\FinalProject\\Resume Template")); // Displays .txt containing resume sample at specified directory
